(function() {
	tinymce.PluginManager.add( 'insert_resettable_iframe', function( editor, url ) {
		
		// Add Button to Visual Editor Toolbar
		editor.addButton('insert_resettable_iframe', {
			title: 'Insert/edit Resettable Iframe',
			image: url + '/icon.svg',
			onclick: function(a) {
				...
				editor.windowManager.open({
					...
					onsubmit: function(e) {
						...
						if(e.data.insert_iframe != ''){
							content = '<div class="framewrapper"><iframe class="resettableiframe" src="' + e.data.iframe_src + '" width="'+e.data.iframe_width+'" height="'+e.data.iframe_height+'"></iframe></div>';
						}
